...
public class FoxNewsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_fox_news, container, false);

        recyclerView = rootView.findViewById(R.id.recyclerView_fox_frag);
        layoutManager = new LinearLayoutManager(getContext());
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setHasFixedSize(true);
        swipeRefreshLayout=rootView.findViewById(R.id.swiperefreshlayout_fox);
    ...
    private void fetchInformation(String url, String en, String s) {
        ...
        Call<NewsModel> call=apiInterface.getSourceWiseNews("fox-news","en","5c16d55fbe864cafa673f4937c31bc87");
