 ...
 */
public class ScienceTechFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_science_tech, container, false);

        recyclerView = rootView.findViewById(R.id.recyclerView_tech_frag);
        layoutManager = new LinearLayoutManager(getContext());
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setHasFixedSize(true);
        swipeRefreshLayout=rootView.findViewById(R.id.swiperefreshlayout_tech);
    ...
    private void fetchInformation(String url, String en, String s) {
        ...
        Call<NewsModel> call=apiInterface.getTopicWiseNews("technology","in","en","5c16d55fbe864cafa673f4937c31bc87");
