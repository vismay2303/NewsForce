...
public class BusinessFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = rootView.findViewById(R.id.recyclerView_business_frag);
        layoutManager = new LinearLayoutManager(getContext());
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setHasFixedSize(true);
        swipeRefreshLayout=rootView.findViewById(R.id.swiperefreshlayout_business);
    ...
    private void fetchInformation(String url, String en, String s) {
        ...
        Call<NewsModel> call=apiInterface.getTopicWiseNews("business","in","en","5c16d55fbe864cafa673f4937c31bc87");
