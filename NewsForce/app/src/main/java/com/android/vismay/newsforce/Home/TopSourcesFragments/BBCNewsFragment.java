...
public class BBCNewsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = rootView.findViewById(R.id.recyclerView_BBC_frag);
        layoutManager = new LinearLayoutManager(getContext());
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setHasFixedSize(true);
        swipeRefreshLayout=rootView.findViewById(R.id.swiperefreshlayout_BBC);
    ...
    private void fetchInformation(String url, String en, String s) {
        ...
        Call<NewsModel> call=apiInterface.getSourceWiseNews("bbc-news","en","5c16d55fbe864cafa673f4937c31bc87");
